...
const products = [
    {
        ...
        stock: 12, rating: 4.8, numReviews: 0
    },
    {
        name: "iPhone 15 Pro",
    ...
    },
    {
        ...
        price: 349, category: "Headphones",
        image: "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=500&auto=format&fit=crop&q=60",
        stock: 25, rating: 4.7, numReviews: 0
    },
    {
...
export const seedProducts = async (req, res) => {
    try {
        ...
        if (existing > 0) {
            return res.json({ success: true, message: `DB already has ${existing} products — no seed needed.`, count: existing });
        }

        await Product.insertMany(products);
        res.json({ success: true, message: `✅ Seeded ${products.length} products into Atlas!` });
    } catch (err) {
